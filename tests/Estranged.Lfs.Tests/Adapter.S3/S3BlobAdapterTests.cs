...
namespace Estranged.Lfs.Tests.Adapter.S3
{
    public class S3BlobAdapterTests : IDisposable
    {
        ...
        public async Task TestDownloadBlobFound()
        {
            ...
            mockClient.Setup(x => x.GetObjectMetadataAsync("my-bucket", "d53de494a038b6a8ede0aea08c38bde00244b155924bf4c463d1de208faecee8", CancellationToken.None))
            ...
            var adapter = new S3BlobAdapter(mockClient.Object, new S3BlobAdapterConfig { Bucket = "my-bucket" });
        ...
        public async Task TestDownloadBlobNotFound()
        {
            ...
            mockClient.Setup(x => x.GetObjectMetadataAsync("my-bucket", "wibble", CancellationToken.None))
